	...
	private void drawBindings(Canvas canvas) {
		for(int i = 0; i < getChildCount(); i++) {
			...
			if(par.getRule(CENTER_HORIZONTAL) == -1) {
				drawHorArrow(canvas, 0, view.getTop() + view.getHeight()/2, view.getLeft(), view.getTop() + view.getHeight()/2);
				drawHorArrow(canvas, view.getRight(), view.getTop() + view.getHeight()/2, getWidth(), view.getTop() + view.getHeight()/2);
			}

			if(par.getRule(CENTER_VERTICAL) == -1) {
				drawVerArrow(canvas, view.getLeft() + view.getWidth()/2, 0, view.getLeft() + view.getWidth()/2, view.getTop());
				drawVerArrow(canvas, view.getLeft() + view.getWidth()/2, view.getBottom(), view.getLeft() + view.getWidth()/2, getHeight());
			}
			...
			if(par.getRule(ABOVE) != 0) {
				...
				if(anchor != null)
					drawBind(canvas, view, anchor, ABOVE);
			}
			...
			if(par.getRule(BELOW) != 0) {
				...
				if(anchor != null)
					drawBind(canvas, view, anchor, BELOW);
			}
			...
			if(par.getRule(LEFT_OF) != 0) {
				...
				if(anchor != null)
					drawBind(canvas, view, anchor, LEFT_OF);
			}
			...
			if(par.getRule(RIGHT_OF) != 0) {
				...
				if(anchor != null)
					drawBind(canvas, view, anchor, RIGHT_OF);
			}
		}
	}
