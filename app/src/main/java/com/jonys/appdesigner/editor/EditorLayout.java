...
public class EditorLayout extends LinearLayout {
    ...
    public EditorLayout(Context context, AttributeSet attrs) {
        ...
        attributes =
                new Gson()
                        .fromJson(
                                FileUtil.readFromAsset("attributes.java", context),
                                new TypeToken<
                                        HashMap<
                                                String,
                                                ArrayList<
        ...
        parentAttributes =
                new Gson()
                        .fromJson(
                                FileUtil.readFromAsset("parent_attributes.java", context),
                                new TypeToken<
                                        HashMap<
                                                String,
                                                ArrayList<
    ...
    public void showDefinedAttributes(final View target) {
        ...
        DefinedAttributesDialogBinding dialogBinding =
                DefinedAttributesDialogBinding.inflate(inflater);
        ...
        final BaseAdapter adapter =
                new BaseAdapter() {
                    ...
                    public View getView(int pos, View buffer, ViewGroup parent) {
                        ...
                        final DefinedAttributeItemBinding itemBinding =
                                DefinedAttributeItemBinding.inflate(inflater);
